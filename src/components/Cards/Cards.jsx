...
import Card3img from './card_3_logo.png'

const Cards = () => {
  return (
    <div className="w-full h-screen flex flex-col lg:flex-row py-16 lg:py-32">
      <div className="w-full lg:w-1/2 h-1/3 lg:h-[30vw] mb-8 lg:mb-0">
        <div className="Card1 relative w-11/12 lg:w-[90%] h-full bg-[#004D43] mx-auto lg:ml-14 rounded-xl flex items-center justify-center">
          <svg className="scale-100 lg:scale-150" xmlns="http://www.w3.org/2000/svg" width="101" height="42" fill="none">
            <path d="M13.802 14.071C5.933 14.243-.064 20.43.001 28.201c.057 7.125 6.421 14.147 14.99 13.532 6.773-.485 12.927-6.327 12.858-13.911-.069-7.584-6.54-13.907-14.047-13.75zm.08 21.74c-4.243 0-7.712-3.628-7.697-8.02a7.722 7.722 0 014.751-7.276 7.73 7.73 0 0110.701 7.322c.023 4.327-3.526 7.981-7.766 7.974h.012zm74.224 5.308h6.05v-26.44h-6.05v26.44zM94.941 0v8.363h5.402c.199 0 .382 0 .657-.027V0h-6.059zM44.277 35.81c-4.244 0-7.713-3.627-7.697-8.018a7.854 7.854 0 017.708-7.767 7.704 7.704 0 016.113 3.085l5.802-2.291c-2.494-4.109-7.014-6.874-12.018-6.755-7.87.172-13.867 6.358-13.802 14.129.058 7.125 6.422 14.147 14.99 13.533a14.137 14.137 0 0011.159-7.19l-5.677-2.525a7.757 7.757 0 01-6.578 3.8zM73.52 13.98a9.132 9.132 0 00-8.08 4.494V0h-6.112v41.096h6.112V26.104c0-4.33 1.7-7.5 5.834-7.5 5.325 0 5.348 5.587 5.348 8.783v13.751h6.18c0-.18.031-.317.031-.458 0-5.136.065-10.269-.023-15.405-.057-3.558-.745-11.295-9.29-11.295z" fill="#CDEA68"/>
          </svg>
          <div className="absolute bottom-4 lg:bottom-6 left-4 lg:left-6 text-[#CDEA68] scale-90 lg:scale-100 font-['Neue_Montreal'] font-light border border-[#CDEA68] px-2 lg:px-3 py-1 rounded-full">
            &copy;2019-2022
          </div>
        </div>
      </div>
      <div className="w-full lg:w-1/2 h-2/3 lg:h-[30vw] flex flex-col lg:flex-row gap-4">
        <div className="Card2 relative h-full w-full lg:w-[47%] bg-[#212121] rounded-xl flex items-center justify-center">
          <svg className="scale-90 lg:scale-125" xmlns="http://www.w3.org/2000/svg" width="119" height="63" fill="none">
            ...
            <path d="M26.488 51.439l-1.726 3.382-3.75.597 2.683 2.687-.591 3.75 3.384-1.721 3.384 1.721-.591-3.75 2.683-2.687-3.75-.597-1.726-3.382zm16.125 0l-1.726 3.382-3.75.597 2.683 2.687-.592 3.75 3.385-1.721 3.385 1.721-.592-3.75 2.683-2.687-3.75-.597-1.726-3.382zm16.121 0l-1.726 3.382-3.75.597 2.683 2.687-.591 3.75 3.384-1.721 3.385 1.721-.592-3.75 2.683-2.687-3.75-.597-1.726-3.382zm16.121 0l-1.726 3.382-3.75.597 2.683 2.687-.591 3.75 3.384-1.721 3.385 1.721-.592-3.75 2.683-2.687-3.75-.597-1.726-3.382zm16.125 0l-1.726 3.382-3.75.597 2.683 2.687-.591 3.75 3.384-1.721 3.385 1.721-.592-3.75 2.684-2.687-3.75-.597-1.727-3.382z" fill="#CDEA68"/>
          </svg>
          <div className="absolute bottom-4 lg:bottom-6 left-4 lg:left-6 text-zinc-200 scale-90 lg:scale-100 font-['Neue_Montreal'] font-light border border-zinc-200 px-2 lg:px-3 py-1 rounded-full">
            RATING 5.0 ON CLUTCH
          </div>
        </div>
        <div className="Card3 relative h-full w-full lg:w-[47%] bg-[#212121] rounded-xl flex items-center justify-center">
          <img className="h-20 lg:h-[9vw] w-20 lg:w-[10vw]" src={Card3img} alt="Card 3 Logo" />
          <div className="absolute bottom-4 lg:bottom-6 left-4 lg:left-6 text-zinc-200 scale-90 lg:scale-100 font-['Neue_Montreal'] font-light border border-zinc-200 px-2 lg:px-3 py-1 rounded-full">
